...
from Leader.strings import strings, HELP_TXT
...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton(" Developer 🇺🇸", url = "https://t.me/Irrlrrr")
    ],[
        InlineKeyboardButton('🐤 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/DZBACC'),
        InlineKeyboardButton('🪐 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/routineweek')
	]]
